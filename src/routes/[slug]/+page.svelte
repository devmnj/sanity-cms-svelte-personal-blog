...
<div>
	...
	<div class="   dark:bg-gray-800 max-w-7xl  py-16 mx-auto space-y-8">

 
			<!-- <article class="  flex-col   dark:bg-gray-800 dark:text-gray-50"></article> -->
			<article class="flex    dark:bg-gray-800 dark:text-gray-50">
								...
								<div class="space-y-4">
									<div class="flex">
										<div class="flex-shrink-0 mr-3">
											<img
												class="hover:ring ring-orange-500 mt-2 rounded-full w-10 h-10 sm:w-10 sm:h-10"
